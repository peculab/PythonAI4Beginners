...
| Week 04  | [Python 程式設計入門（下）](https://colab.research.google.com/drive/1k1QHGqlsep5c-MgMkE7bNVVfu7Sw_FhJ?usp=sharing)<br>撰寫一個簡單的聊天機器人來回答常見問題    | 蔡芸琤 | 鈞賢 | [HW1]() |
...
- 務必依下列格式並依順序命名：
- 學號_姓名_作業次數.rar
- ex: pyt414199_易栢芬_hw1.rar
- 線上課程 ex: pyon414199_易栢芬_hw1.rar
- ※中間不可加上任何空白或其它任意符號及文字(否則系統將會無法判斷內容)
- ※若未依規定檔案名稱格式繳交則視為缺交
- 壓縮檔格式不限 zip/rar/7z/tar 均可
- 作業次數為第幾次的作業，而非第幾個檔案
- 在課程結束前均可繳交
- ●若發現有交錯，以相同檔案名稱重新上傳即可，以最後一次提交的版本為準！
- ●若有作業內容有二題或以上的(含加分題)，請壓縮在同一個壓縮檔。
- ●詳細的題目內容請看課程投影片，或是批改系統也會有相同的題目。
